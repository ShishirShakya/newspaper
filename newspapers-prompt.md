...
3. Open the search results page (keyword "certificate of need", date 1960-2026, location North Carolina). The Python script uses the direct results URL; in MCP you can navigate to that URL or fill the form.
